          ...
          <div className="col-lg-6 p-0 d-flex flex-column">
            <div className="athelete-section h-100">
              ...
              <p>
                ...
                conditioning training plans for any athlete. Our programmes are
                designed by accredited strength & conditioning coaches with
                years of experience. Programmes are tailored specifically to
                each athlete’s training needs & goals covering a range of
          ...
          <div className="col-lg-6 p-0 d-flex flex-column">
            <div className="coach-section h-100">
              ...
              <p>
                ...
                create a training plan that can be tailored specifically to each
                of your athlete’s training needs & goals. Our programmes cover a
                range of sports for amateur, semi-professional & professional
                athletes.
              </p>
              <a href="#" className="learn_more">
                Learn More
