          ...
          <div className="col-lg-4 col-md-4">
            <div className="athlete-content pt-lg-5 text-right">
              ...
              <p>
                ...
                Coach. Access athlete's reports such as their well-being scale,
                training details, training intensity, and volume and number of
                performed or engaged sessions to monitor their progress. Easily
                share reports with other coaches to ensure the whole coaching
                team’s in the loop. Also use the leader board to highlight the
                best performer within the team at any given time.
              </p>
            </div>
          </div>
        </div>
